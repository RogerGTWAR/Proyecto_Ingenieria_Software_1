        ...
        <div className="flex-1 space-y-5 overflow-y-auto bg-slate-100 p-4 sm:p-6">
          <section className="rounded-3xl border border-slate-300 bg-slate-200 p-4 shadow-sm sm:p-6">
            <div className="mb-5 border-b border-slate-300 pb-4">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Datos principales del proveedor seleccionado.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <InfoBox
                label="Categoría"
                value={proveedor.categoriaNombre || "Sin categoría"}
                variant="blue"
              />
              ...
              <InfoBox label="Ciudad" value={proveedor.ciudad || "—"} />

              <InfoBox label="País" value={proveedor.pais || "—"} />
            </div>
          </section>
          ...
          <section className="rounded-3xl border border-slate-300 bg-slate-200 p-4 shadow-sm sm:p-6">
            <div className="mb-5 border-b border-slate-300 pb-4">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Contacto, teléfono y correo del proveedor.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <InfoBox
                label="Contacto"
                value={proveedor.nombre_contacto || "No registrado"}
              />

              <InfoBox
                label="Cargo"
                value={proveedor.cargo_contacto || "—"}
              />
