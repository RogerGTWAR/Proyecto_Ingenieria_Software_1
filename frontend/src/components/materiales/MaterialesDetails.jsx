          ...
          >
            <div className="mb-5 border-b border-slate-300 pb-4">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Datos principales del material seleccionado.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <InfoBox label="Nombre" value={material.nombre_material || "—"} />

              <InfoBox
                label="Categoría"
                value={material.categoriaNombre || "Sin categoría"}
              />

              <InfoBox
                label="Unidad de Medida"
                value={material.unidad_de_medida || "—"}
              />
